...
$query = "SELECT courses.*, Username, categories.Name FROM courses INNER JOIN users ON users.Id = courses.InstructorId 
INNER JOIN categories ON courses.categoryId = categories.Id";
